...
int led_device_create(int minor)
{
    ...
    DEBUG_LOG("Enter!");
    led_drv_device = device_create(led_drv_class, NULL, MKDEV(major, minor), NULL, "%s_%d", g_led_oprts->dev_name, minor);
